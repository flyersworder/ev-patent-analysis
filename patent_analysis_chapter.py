...
def _(mo):
    ...
    **Table 7: Hypothesis Testing Results and Theoretical Implications**
    ...
    | **H4: Business Model Innovation → Alternative Pathway**<br/>Cross-industry business model transfer enables market competitiveness despite patent quality gaps when product characteristics align | **Predicted pattern:**<br/>China achieves market penetration through consumer electronics business logic despite low patent quality | **Actual pattern:**<br/>• **China: Last in volume (14.2%), 2.6× quality disadvantage (2.80 vs. US 7.16)**, yet substantial market penetration<br/>• Rapid iteration: 24 months vs. 40-50 months (traditional)<br/>• Lowest self-citation (21.5%) → aggressive external knowledge absorption<br/>• Manufacturing-centric (28.6% of GDP, highest)<br/>• Strategic domain focus: Batteries as infrastructure (7-fold growth), infotainment through implementation speed<br/><br/>**Evidence:**<br/>• Business model characteristics align with EV modularity, software-centricity, network effects<br/>• Implementation excellence over invention depth drives market competitiveness | **SUPPORTED** | Establishes business model innovation as independent strategic pathway. Competitive advantage stems from **how** firms commercialize (business architecture) rather than **what** they invent (technological superiority). Cross-industry transfer (consumer electronics → automotive) succeeds when product characteristics align: modularity enables rapid iteration, software-centricity enables digital experience differentiation, network effects enable ecosystem lock-in. Challenges patent-centric assumptions: patent leadership neither necessary nor sufficient when business models diverge. Extends Teece (2010): commercialization speed and scale can offset R&D gaps. |
...
def _(mo):
    ...
    Nature Human and Social Sciences Communications Editorial. (2025). Evolutionary game theory in technology competition: Lessons from electric vehicles. *Nature Human and Social Sciences Communications*, 12(1), 1-3. https://doi.org/10.1057/s41599-025-02156-8
