...
def _(mo):
    ...
    This paper analyzes innovation competition among five major regions, each pursuing fundamentally different strategies reflecting distinct National Innovation Systems and resource endowments:

    **The United States** treats EVs as software platforms, concentrating on autonomous driving (RCA=1.22) and infotainment (RCA=1.37). US innovation emphasizes foundational, cross-domain research, maintaining the highest patent quality (8.87 avg citations) through university-industry collaboration and venture capital-backed experimentation.
    ...
    **New empirical discoveries**: We reveal previously unknown patterns challenging conventional wisdom: (1) Europe's "legacy trap"—strong specialization in traditional automotive domains (RCA 1.59-1.65) but critical weakness in future-defining technologies (batteries 0.63, infotainment 0.67), contradicting narratives of unfocused R&D; (2) the "Korea-China battery paradox"—Korea leads innovation (31% patent share) while China dominates production (53% market share), revealing patent-to-market lags; (3) US "openness paradox"—highest quality patents (8.87 citations) combined with highest outbound learning (net +3,620 citations), demonstrating competitive advantage through open innovation rather than insularity; (4) China's counterintuitive openness—lowest self-citation rate (21.2%) despite narratives of technological nationalism, yet geopolitical collapse with US (-64% to -70% flows) overrides complementarity.

    **Methodological innovation**: First comprehensive five-region comparative analysis (US, China, EU, Korea, Japan) integrating volume, quality (forward citations with wild bootstrap inference), collaboration patterns, knowledge flows, and Hall-Jaffe-Trajtenberg generality/originality indices. Assignee-based counting (not patent office location) captures "export-quality" innovation only. Analyzing 385,000+ patents across seven technology domains and 11 years with full reproducibility (all SQL queries, data, and code publicly available at https://github.com/flyersworder/ev-patent-analysis).

    **Theory-driven interpretation**: Integrating Resource-Based View, National Innovation Systems, Disruptive Innovation theory, and Open Innovation perspectives to systematically explain observed patterns. Five explicit propositions tested with strong empirical support (Section 5.3), demonstrating existing theories successfully explain complex EV innovation dynamics when properly integrated—validating theory in new empirical context while revealing boundary conditions (e.g., geopolitics override economic complementarity).

    **Mechanism explanation via China case study**: While comparative analysis reveals WHAT patterns exist, the China case study explains WHY through business model innovation theory. We demonstrate China's observed patterns—moderate patent shares, lower citation quality, counterintuitively low self-citation—reflect deliberate strategic choices importing consumer electronics logic (rapid iteration, volume-based cost reduction) rather than innovation weakness. This reveals an alternative pathway to competitiveness not requiring traditional patent leadership, with critical implications: Europe cannot replicate China's model due to incompatible structural advantages (manufacturing scale, state subsidies, domestic market protection).

    **Actionable strategic pathways**: Evidence-based recommendations for Europe prioritizing defensible domains (thermal management, safety), strategic alliances (EU-Korea batteries, EU-US knowledge flows), and differentiation strategies (privacy, sustainability, lifecycle optimization). Three alternative futures with probabilistic assessment and robust strategies effective across scenarios.

    This paper unfolds as follows: **Theoretical Framework** integrates Resource-Based View, Disruptive Innovation theory, National Innovation Systems, and Open Innovation perspectives, developing five testable propositions linking theory to observable metrics. **The Five-Region Race** examines patent competition across seven EV technology domains, revealing distinct regional strategies and the EU's "legacy trap." **Patent Quality Analysis** employs forward citation analysis to assess technological impact beyond volume. **Cross-Border Collaboration and Knowledge Flows** investigates collaboration patterns and knowledge networks, including systematic testing of theoretical propositions. **China Case Study** examines cross-industry business model innovation as a disruptive competitive strategy. **EU Strategic Imperatives** translates findings into actionable policy recommendations and alternative futures. **Conclusion** synthesizes implications for European competitiveness.
...
def _(mo):
    ...
    These five frameworks are not competing explanations but complementary lenses illuminating different facets of the same phenomena. Together, they generate testable propositions linking theoretical constructs to observable patent metrics:

    **Proposition 1 (National Innovation Systems → Citation Quality):** Regions with stronger university-industry linkages will generate higher-quality patents (measured by forward citations) because academic collaboration produces foundational research with broader applicability. The US innovation system emphasizes university-industry collaboration (Stanford-Silicon Valley, MIT-Route 128), producing foundational research published and cited widely. EU systems emphasize industry-led applied research, generating proprietary knowledge with narrower applicability. China's system prioritizes rapid commercialization over academic citation networks.

    **Proposition 2 (Resource-Based View → Domain Specialization):** Regional domain specializations will persist over time due to path-dependent capability accumulation. Regions leading in specific technology domains in 2014 should maintain relative advantages in those domains through 2024, with shifts requiring massive coordinated investment (e.g., China's battery scale-up, Korea's battery excellence). EU thermal management strength, US software dominance, and Korean battery leadership should exhibit stability absent major policy interventions.

    **Proposition 3 (Disruptive Innovation → Citation Patterns):** Patents targeting disruptive technology shifts will receive higher citations than patents improving sustaining technologies because disruptive innovations create new research trajectories while sustaining innovations serve existing customer needs. EU patents may receive fewer citations because they improve sustaining technologies (better combustion engines → hybrids) while US/China patents target disruptive shifts (BEV architecture, software-defined vehicles). Software-intensive domains (autonomous driving, infotainment) should generate higher citations than incremental hardware improvements.

    **Proposition 4 (Open Innovation → Collaboration Rates):** Cross-regional collaboration rates will increase when regions possess highly complementary capabilities and decrease under geopolitical friction. EU-Korea collaboration should be high (EU thermal + Korean batteries), US-China collaboration should collapse post-2018 (trade war, technology decoupling), and overall collaboration rates should remain low due to strategic competition in winner-take-all platform battles (batteries, software).

    **Proposition 5 (Knowledge Tacitness → Citation Variance):** Software innovations will receive higher citations than hardware innovations because codifiable knowledge diffuses more widely than tacit knowledge. Autonomous driving algorithms can be described, published, and adapted across contexts (high citations). Battery chemistry knowledge involves undocumented manufacturing expertise (lower citations despite commercial importance). This explains why software-centric domains generate 2-3× higher citations than hardware domains regardless of region.

    The following empirical sections test these propositions through patent data analysis, revealing how regional capabilities (RBV), institutional arrangements (NIS), disruption dynamics, collaboration patterns (open innovation), and business models manifest in concrete metrics of patent volume, citation quality, domain specialization, and knowledge flows.
    """
    )
    return
...
def _(mo):
    ...
    Korea's battery patents present an interesting anomaly: highest volume (31% share) but moderate citation quality (3.63 citations, 2nd of 5), with US battery patents (7.69) generating 2.1× more impact. For a detailed analysis of this patent-market gap, see Box 1, Section 3. These regional quality differences align with the theoretical propositions outlined in Section 2: NIS institutional differences (Proposition 1), resource-based domain specialization (Proposition 2), disruptive versus sustaining innovation patterns (Proposition 3), and knowledge tacitness effects (Proposition 5). The empirical patterns consistently support theoretical expectations.
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Testing Theoretical Propositions: Empirical Support

    Having presented empirical evidence across patent volumes (Section 3), citation quality (Section 4), and collaboration/knowledge flows (Section 5.1-5.2), we now systematically assess whether the data support the five theoretical propositions outlined in Section 2. Table 7 summarizes findings:

    **Table 7: Empirical Support for Theoretical Propositions**

    | Proposition | Key Evidence | Support Level | Sections |
    |-------------|-------------|---------------|----------|
    | **P1: NIS → Citation Quality**<br/>University-industry linkages increase patent citations | • US: 8.87 avg citations (highest university-industry collaboration)<br/>• EU: 2.50 avg citations (industry-led R&D)<br/>• China: 3.31 avg citations (commercialization focus) | **Strongly Supported** | 2, 4 |
    | **P2: RBV → Domain Specialization**<br/>Regional specialization persists due to path dependency | • Korea batteries: 29.8% → 32.7% (sustained leadership, growing)<br/>• EU hybrids: 32.2% → 33.4% (retained leadership, +1.2pp)<br/>• US autonomous: 31.1% → 35.3% (gained leadership from EU)<br/>• Same regional leader in 5 of 7 domains (2014-2023) | **Strongly Supported** | 2, 3 |
    | **P3: Disruption → Citation Patterns**<br/>Disruptive patents receive higher citations | • Software domains: 2-3× citations vs hardware<br/>• EU hybrids (sustaining): lowest citations<br/>• US autonomous (disruptive): highest citations<br/>• EU ranks last in 6/7 domains despite volume | **Strongly Supported** | 2, 4 |
    | **P4: Open Innovation → Collaboration**<br/>Complementarity increases, friction decreases collaboration | • EU-Korea (complementary): 5,410 patents (2nd highest)<br/>• US-CN collapse: -96.8% (2020-2024) post-friction<br/>• Overall collaboration: 0.65-1.28% (strategic competition)<br/>• Geopolitics override complementarity | **Partially Supported** | 2, 5.1, 5.2 |
    | **P5: Tacitness → Citation Variance**<br/>Software (codifiable) > Hardware (tacit) citations | • Autonomous: 6.79 avg citations<br/>• Batteries: 3.77 avg citations<br/>• Software domains consistently 2-3× hardware<br/>• Pattern holds across all regions | **Strongly Supported** | 2, 4 |

    Four of five propositions receive strong empirical support. **Proposition 1** (NIS institutional differences) is validated: US university-industry collaboration produces 3.5× higher citation quality than EU industry-led systems (8.87 vs 2.50 citations). **Proposition 2** (RBV path dependency) is confirmed: regional domain leaders persist across the decade—5 of 7 domains retain the same regional leader from 2014 to 2023, with Korea sustaining battery leadership (29.8%→32.7%), EU retaining hybrids (32.2%→33.4%), and US gaining autonomous driving leadership from EU (31.1%→35.3%)—demonstrating that accumulated capabilities resist rapid displacement absent massive coordinated investment like China's battery scale-up.

    **Proposition 3** (disruptive innovation) receives particularly strong support: software-intensive domains generate 2-3× higher citations than hardware domains across all regions, EU's strength in declining technologies (hybrids) correlates with lowest citation impact, and the EU ranks last in citation quality in 6 of 7 domains despite second-highest patent volumes—precisely the pattern predicted for incumbents strengthening sustaining innovations while losing ground in disruptive domains. **Proposition 5** (knowledge tacitness) is consistently validated: autonomous driving (6.79 citations) and infotainment (5.86) substantially exceed batteries (3.77) and thermal management (2.44), supporting the theory that codifiable software knowledge diffuses more widely than tacit manufacturing expertise.

    **Proposition 4** (open innovation and collaboration) receives partial support with important caveats. Complementarity does predict collaboration where geopolitical friction is absent: EU-Korea partnerships (5,410 patents) leverage complementary capabilities (EU thermal + Korean batteries). However, the US-China collapse (-96.8% decline, 2020-2024) demonstrates that geopolitical considerations override technological complementarity—contradicting pure open innovation predictions. Overall collaboration rates remain extremely low (0.65-1.28%) despite extensive complementarity across regions, suggesting strategic competition in platform battles (batteries, software) creates winner-take-all dynamics discouraging knowledge sharing. The proposition holds conditionally: complementarity increases collaboration *only when institutional and geopolitical conditions permit*, but these conditions are increasingly restrictive.

    These findings validate the theoretical framework's explanatory power while revealing boundary conditions. Resource-based capabilities, institutional arrangements, and disruption dynamics robustly explain regional patent patterns. Open innovation theory requires modification to account for geopolitical fragmentation and strategic platform competition.

    ### Novel Empirical Discoveries Beyond Theory Testing

    While the propositions receive strong support, our analysis reveals four empirical patterns previously unknown in the literature that challenge conventional wisdom: **(1) Europe's "legacy trap":** EU exhibits strong specialization (RCA 1.59-1.65) in traditional automotive domains—hybrids, thermal management, safety—but critical weakness in future-defining technologies (batteries 0.63, infotainment 0.67), contradicting narratives of unfocused R&D. The problem is not lack of specialization but strategic misalignment with future value capture. **(2) Korea-China battery paradox:** Korea dominates innovation (31-33% patent share) while China dominates production (53% market share), revealing significant patent-to-market lags and the distinction between innovation leadership versus commercialization dominance. **(3) US openness paradox:** Despite generating highest-quality patents (8.87 citations), US exhibits highest outbound learning (net +3,620 cross-regional citations in 2023), demonstrating competitive advantage stems from open innovation culture—combining internal excellence with aggressive external knowledge absorption—rather than insularity. **(4) China's counterintuitive openness:** China exhibits the lowest self-citation rate (21.2%), contradicting narratives of technological nationalism, yet geopolitical frictions (-64% to -70% US-China flows post-2021) override economic complementarity. These discoveries provide strategic intelligence for policymakers while demonstrating existing theories successfully explain complex innovation dynamics when properly integrated. The next section examines China's cross-industry business model innovation as a case study illustrating how these theoretical dynamics manifest in practice.
    """
    )
    return
...
def _(mo):
    ...
    While Sections 3-5 documented WHAT patterns exist—China's moderate patent shares, lower citation quality (2.80 vs. US 7.16), counterintuitively low self-citation (21.2%), and selective domain focus—this case study explains WHY through business model innovation theory (Teece, 2010; Enkel & Gassmann, 2010). Chinese manufacturers have systematically transferred consumer electronics business logic into automotive manufacturing: rapid iteration, volume-based cost reduction, digital experience differentiation, and ecosystem lock-in. This cross-industry knowledge transfer enables disruptive innovation by redefining competition along dimensions where incumbents possess limited advantages. Our patent analysis reveals how this "EVs as smartphones" model manifests across hardware priorities, quality metrics, and knowledge absorption strategies—demonstrating an alternative pathway to competitiveness not requiring traditional patent leadership.
...
def _(mo):
    ...
    This analysis reveals a European paradox: the EU produces the second-highest patent volumes globally yet ranks last in citation quality (2.50 vs. US 8.87), holds leadership in only two of seven core domains, and experiences share declines in six technology domains over the past decade. These patterns signal fundamental strategic misalignment between European innovation systems and emergent competitive realities in EV markets.
