...
def _(mo):
    ...
    **Date:** October 2025
    ...
    This paper examines a troubling paradox in electric vehicle innovation: Europe ranks third in patent volume among five major regions (20.2% in 2023) yet last in innovation quality. Analyzing 385,000+ patents across the United States, China, the EU, South Korea, and Japan from 2014-2024, we employ forward citation analysis, cross-border collaboration patterns, and knowledge flow networks to assess technological impact. Europe's patent share declined 9 percentage points affecting six of seven domains, with growth only in declining hybrid powertrains. European patents (2014-2018 cohort) average 2.58 forward citations versus 9.97 for the United States—a 3.9× quality gap. We formulate three theory-driven hypotheses synthesizing Resource-Based View, National Innovation Systems, and Open Innovation frameworks: (H1) state-led systems should exhibit higher self-citation; (H2) higher patent volumes should correlate with higher citation quality; (H3) collaboration should increase as regional specialization deepens. Two hypotheses are decisively rejected while one receives partial support, revealing critical theoretical gaps and boundary conditions. Counterintuitively, China exhibits the lowest self-citation rate (21.5%), while the United States shows the second-highest (48.2%), contradicting NIS predictions. RBV receives conditional support: volume-quality correlation holds for the United States (1st volume/1st quality, 2014-2018 cohort) but fails for the EU (2nd volume/last quality), revealing a "competency trap" where capabilities in declining technologies harm quality. Korea demonstrates efficiency: 4th volume, 2nd quality. United States-China collaboration collapsed 76% (2020-2023) despite complementarity, demonstrating that geopolitical friction overrides the open innovation logic. These insights—state coordination's dual faces, RBV's conditional validity, and geopolitical boundaries—represent core contributions. Strategic imperatives for Europe include anchoring in defensible domains (thermal management, safety), forging strategic alliances (EU-Korea, EU-United States), and differentiating on privacy and sustainability.
...
def _(mo):
    ...
    **Japan** represents the incumbent's dilemma: pioneering hybrid vehicles yet struggling in software-intensive domains, with solid but not transformative patent quality (3.47 citations)—a pattern shared with the EU.
    ...
    **Theoretical contributions through hypothesis testing**: We formulate three theory-driven hypotheses synthesizing Resource-Based View, National Innovation Systems, and Open Innovation frameworks. Two are decisively rejected while one receives partial support, revealing critical theoretical gaps and boundary conditions. (H1) NIS theory predicts state-led systems exhibit higher self-citation (insularity), yet China shows the lowest (21.5%) while market-driven US shows second-highest (48.2%)—extending NIS theory beyond developed-economy contexts to reveal state coordination's dual faces in catch-up versus frontier innovation. (H2) RBV predicts volume-quality correlation and receives conditional support: correlation holds for US (1st volume 30.8%, 1st quality 9.97 citations, 2014-2018 cohort) but fails for EU (2nd volume 24.9%, last quality 2.58)—revealing the "competency trap" where capabilities in declining technologies harm quality. Korea demonstrates efficiency: 4th volume (14.7%), 2nd quality (4.11). (H3) Open innovation theory predicts complementarity drives collaboration, yet US-China flows collapsed 76% (2020-2023) despite intensifying specialization—demonstrating geopolitical friction overrides economic logic. These insights represent core contributions to innovation theory (Section 5.3).
...
def _(mo):
    ...
    **H2 (Resource-Based View → Volume-Quality Relationship):** Regional patent volume will correlate positively with average citation quality across all five regions. Regions with larger patent portfolios (higher volume) will exhibit higher average forward citations (higher quality).
    ...
    **H3 (Open Innovation → Collaboration Under Complementarity):** Cross-regional collaboration rates will increase over time (2014→2024) as technological specialization deepens. Regions with highly complementary capabilities will exhibit the highest collaboration rates.
