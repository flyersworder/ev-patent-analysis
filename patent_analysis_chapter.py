...
def _(mo):
    ...
    Why do different regions exhibit such divergent patent patterns in electric vehicle innovation? The EU produces second-highest volumes yet ranks last in citation quality; Korea dominates batteries despite China's manufacturing scale; US software leadership contrasts with Korean battery excellence; cross-border collaboration remains minimal despite technological complementarity. Understanding these patterns requires integrating multiple theoretical perspectives from innovation studies, strategic management, and industrial economics. We draw on five complementary frameworks—Resource-Based View, National Innovation Systems, Disruptive Innovation theory, Open Innovation, and Business Model Innovation—that together explain how regional capabilities, institutional arrangements, and strategic choices manifest in observable patent metrics.
...
def _(mo):
    ...
    Patent Share Projections (2030): EU stabilizes at 30-32% (recovery from 17-20%), China 28-30% (growth from 14-16%), US 24-26%, Korea 12-14%, Japan 6-8%.
    ...
    4. Selective Globalization: Collaboration with Japan (hybrids) and Korea (batteries) remains valuable across scenarios, hedging against US-China decoupling while accessing complementary expertise. EU-US knowledge flows (13,139 citations; Section 5.2) should be protected as strategic assets.
