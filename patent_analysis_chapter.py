...
def _(mo):
    ...
    **Methodological innovation**: First comprehensive five-region comparative analysis (US, China, EU, Korea, Japan) integrating volume, quality (forward citations with wild bootstrap inference), collaboration patterns, and knowledge flows. Assignee-based counting (not patent office location) captures "export-quality" innovation only. Analyzing 385,000+ patents across seven technology domains and 11 years with full reproducibility (all SQL queries, data, and code publicly available at https://github.com/flyersworder/ev-patent-analysis).
