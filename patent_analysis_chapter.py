...
def _(mo):
    ...
    **Table 7: Empirical Support for Theoretical Propositions**
    ...
    | **P2: RBV → Domain Specialization**<br/>Regional specialization persists due to path dependency | • EU thermal: 44% share (2014) → 44% (2023)<br/>• Korea batteries: 27% → 31% (growing dominance)<br/>• US software: 53-60% stable (2014-2024)<br/>• All domains show persistent leaders | **Strongly Supported** | 2, 3 |
    ...
    Four of five propositions receive strong empirical support. **Proposition 1** (NIS institutional differences) is validated: US university-industry collaboration produces 3.5× higher citation quality than EU industry-led systems (8.87 vs 2.50 citations). **Proposition 2** (RBV path dependency) is confirmed: regional specializations persist across the decade—EU thermal management (44% stable), Korean batteries (27%→31% growth), US software dominance (53-60% stable)—demonstrating that accumulated capabilities resist rapid displacement absent massive coordinated investment like China's battery scale-up.
